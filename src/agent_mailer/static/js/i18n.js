...
(function () {
  ...
  const translations = {
    'zh-CN': {
      ...
      'admin.agentsTitle': 'Agents 管理',
      'admin.agentsNew': '新建 Agent',
      'admin.agentsShowDeleted': '显示已删除',
      'admin.agentsEmpty': '暂无 Agent。',
      'admin.agentsColName': '名称',
      'admin.agentsColRole': '角色',
      'admin.agentsColAddress': '邮箱地址',
      'admin.agentsColApiKey': 'API Key',
      'admin.agentsColStatus': '状态',
      'admin.agentsStatusActive': '在用',
      'admin.agentsStatusDeleted': '已删除',
      'admin.agentsEdit': '编辑',
      'admin.agentsRegen': '重生成 Key',
      'admin.agentsDelete': '删除',
      'admin.agentsNewTitle': '新建 Agent',
      'admin.agentsEditTitle': '编辑 Agent — {name}',
      'admin.agentsFieldName': 'Name',
      'admin.agentsFieldAddress': '邮箱地址前缀',
      'admin.agentsAddressDefault': '默认 = name',
      'admin.agentsFieldRole': '角色 (role)',
      'admin.agentsFieldDescription': '简介 (description)',
      'admin.agentsFieldSystemPrompt': '身份提示词 (system_prompt)',
      'admin.agentsFieldTags': '标签 (逗号分隔)',
      'admin.agentsTagsHint': 'pm, p1, ...',
      'admin.agentsFieldTeam': '所属 Team',
      'admin.agentsTeamNone': '— 未分组 —',
      'admin.agentsTeamLoadFailed': '— 加载 Team 失败 —',
      'admin.agentsErrorName': '请填写 name',
      'admin.agentsKeyCreatedTitle': 'API Key 已生成 — 请立即复制保存',
      'admin.agentsKeyRegenTitle': 'API Key 已重生成 — 旧 Key 立即失效',
      'admin.agentsKeyOnceWarn': '此 API Key 只显示一次，关闭后无法再次查看。',
      'admin.agentsRegenTitle': '重生成 API Key',
      'admin.agentsRegenConfirm': '为 "{name}" 生成新 Key？旧 Key 将立即失效。',
    ...
    'en-US': {
      ...
      'admin.agentsTitle': 'Agents Management',
      'admin.agentsNew': 'New Agent',
      'admin.agentsShowDeleted': 'Show deleted',
      'admin.agentsEmpty': 'No agents.',
      'admin.agentsColName': 'Name',
      'admin.agentsColRole': 'Role',
      'admin.agentsColAddress': 'Address',
      'admin.agentsColApiKey': 'API Key',
      'admin.agentsColStatus': 'Status',
      'admin.agentsStatusActive': 'Active',
      'admin.agentsStatusDeleted': 'Deleted',
      'admin.agentsEdit': 'Edit',
      'admin.agentsRegen': 'Regen Key',
      'admin.agentsDelete': 'Delete',
      'admin.agentsNewTitle': 'New Agent',
      'admin.agentsEditTitle': 'Edit Agent — {name}',
      'admin.agentsFieldName': 'Name',
      'admin.agentsFieldAddress': 'Address local-part',
      'admin.agentsAddressDefault': 'defaults to name',
      'admin.agentsFieldRole': 'Role',
      'admin.agentsFieldDescription': 'Description',
      'admin.agentsFieldSystemPrompt': 'System prompt',
      'admin.agentsFieldTags': 'Tags (comma-separated)',
      'admin.agentsTagsHint': 'pm, p1, ...',
      'admin.agentsFieldTeam': 'Team',
      'admin.agentsTeamNone': '— Ungrouped —',
      'admin.agentsTeamLoadFailed': '— Failed to load teams —',
      'admin.agentsErrorName': 'Name is required',
      'admin.agentsKeyCreatedTitle': 'API Key generated — copy now',
      'admin.agentsKeyRegenTitle': 'API Key regenerated — old key revoked',
      'admin.agentsKeyOnceWarn': 'This API key is shown once. Cannot be retrieved later.',
      'admin.agentsRegenTitle': 'Regenerate API Key',
      'admin.agentsRegenConfirm': 'Regenerate key for "{name}"? Old key will be revoked immediately.',
